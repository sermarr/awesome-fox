...
--
local theme         = {}
theme.dir           = os.getenv("HOME") .. "/.config/awesome/themes-fox/archblue"
...
--theme.menu_fg_focus 	The default focused item foreground (text) color.
--theme.menu_bg_focus 	The default focused item background color.
--theme.menu_fg_normal 	The default foreground (text) color.
--theme.menu_bg_normal 	The default background color.
